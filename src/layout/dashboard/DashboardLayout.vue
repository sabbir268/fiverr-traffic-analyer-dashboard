  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <!-- <sidebar-link to="/icons" name="Blog" icon="tim-icons icon-atom"/> -->
        <sidebar-link to="/typography" name="Category" icon="tim-icons icon-align-center"/>
        ...
        <sidebar-link to="/table-list" name="Blog" icon="tim-icons icon-puzzle-10"/>
